...
export const wikiAttrPrefixedCases: WikiRefTestCase[] = [
  ...
  {
    descr: 'wikiattr; prefixed; malformed; headers not supported in wikiattrs',
    mkdn: ':attrtype::[[fname-a#header-text]]\n',
    html: '<p><a class="wiki link type reftype__attrtype" href="/tests/fixtures/fname-a#header-text" data-href="/tests/fixtures/fname-a#header-text">title a</a></p>\n',
  },
];
